%&"precompiledd"
% remove the last d in order to use precompiled.fmt instead of style.sty. See Gruntfile.js

%\RequirePackage[l2tabu, orthodox]{nag}

\documentclass[paper=a4,fontsize=11pt,twoside,openany,final]{scrbook}
...
\input{./macros.tex}
\input{./content/glossary_acronyms.tex}
\addbibresource{./bibliography/bibliography.bib}

\newcommand{\version}{\textcolor{red}{DRAFT}}
...
\begin{document}
	...
	\mainmatter
		...
		\import{content/project-dat/}{project-dat.tex}
