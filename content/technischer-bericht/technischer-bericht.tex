...
Mit GeoKettle\footnote{\url{http://www.geokettle.org/}} existiert eine Geo-Erweiterung. Laut \cite{sfkeller} werde diese nicht weiter entwickelt.
...
Yahoo! hat am 4. July 2015 angekündigt, dass Pipes am 30. September 2015 abgeschaltet wird.
...
\item Ausbau des Transformations-Assistenten: Für einfache Transformationen ist der Assistent gut geeignet. Sobald allerdings Funktionen verwendet werden sollen, muss die Transformation direkt in ODHQL geschrieben werden.
\end{itemize}
