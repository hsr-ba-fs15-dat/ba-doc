...
\newglossaryentry{geojson}{name=GeoJSON, description={ist eine auf JSON basierende Schema-Spezifikation für Geo-Daten}, url={http://geojson.org/}}
...
\newacronym
[description={\acrlong{ifs}. Ein Institut der \acs{hsr}},url={http://www.ifs.hsr.ch/}]
...
\newacronym
[shortplural=APIs,description={\acrlong{api}}]
