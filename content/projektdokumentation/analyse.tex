...
Zusätzlich werden die in \cref{tab:pd:format-criteria-transform} beschriebenen Kriterien für die Bewertung der Transformations-Sprachen verwendet.
\mytable{lXc}{
...
Ein aktuellerer Ansatz, ist es, einen signierten Token im Header jedes Requests der zum Server gesendet wird anzugängen. Diese Methode bietet folgende Vorteile:
