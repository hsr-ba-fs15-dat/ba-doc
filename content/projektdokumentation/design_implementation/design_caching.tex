...
\section{Caching}
Aufgrund der Entscheidung alle Daten Verlustfrei im Originalformat zu speichern (\cref{dec:pd:datenspeicherung}) sowie der Verwendung von In-Memory Tabellen-artigen Datenstrukturen \xxx[evtl cref entscheidung?], muss sichergestellt werden, dass nicht bei jeder Operation die Originaldaten von Format-Parser neu eingelesen werden müssen.\\
