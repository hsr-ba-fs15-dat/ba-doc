...
\mytable{lX}{
  ...
  \midrule
  Level 1 & Der Level 1 Cache ist ein In-Memory Cache und sehr kurzlebig (\SI{60}{\second}). Dieser wird hauptsächlich verwendet, um Zwischenresultate wie Formatkonversionen oder Resultate einer Abfrage zu speichern, damit der Benutzer im Webfrontend die Daten sofort mittels Pagination anschauen kann.\\
