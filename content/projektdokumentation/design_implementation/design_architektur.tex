...
\cref{fig:pd:pypackages} erläutert die Package-Struktur und Inhalt der Python Module. Alle Python Module die sich im \path{plugins} Modul befinden, werden automatisch geladen. Darin befinden sich auch Beispiel-Plugins einer \acs{odhql}-Funktion sowie zur Erweiterung der Format-Unterstützung.
