...
\xxx native unterstützung formate interlis/gml
\xxx unterstützung interlis2
\xxx bessere CRUD möglichkeiten (z.b. files austauschen/hinzufügen)
\xxx nach und nach mehr funktionen einbauen (nach bedarf)
\xxx performance/streaming aspekt
\xxx möglichkeit wie bei ogr sql auf der DB auszuführen mit kosten-penalty
\xxx möglichkeit zur ``diskussion'' von transformationen/daten
\xxx CKAN forken
\xxx GDAL 2.0
\xxx datentypen erweitern
\xxx bessere handhabung geodaten
\xxx support für nested daten
\xxx mehr formate unterstützen (nach bedarf)
\xxx flexiblere API (adhoc alles, odh nur noch als ``calc/transformation'' engine verwenden)
