...
Dieses Format lehnt sich an SELECT aus SQL an. Es ist anzunehmen, dass Experten im Bereich Datentransformation sich mit SQL auskennen, was das erlernen dieser Query-Sprache sehr vereinfachen würde.
...
\subsection{Fazit}
Ogrtransform unterstützt nur Geo-Daten. Da OpenDataHub jedoch auch andere Daten unterstützten soll, kommt es als Transformations-Sprache nicht in Frage.

Ein eigenes Format würde die grösste Flexibilität bieten. SQL ist jedoch perfekt geeignet für die Aufgabe und bietet ausserdem den Vorteil, dass es bereits bekannt ist. Daher entscheiden wir uns für eine an SQL angelehnte Sprache.
