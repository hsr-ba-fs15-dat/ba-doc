...
\newglossaryentry{sloan-foundation}{name=Sloan Foundation, description={ist eine amerikanische non-profit Stiftung für Forschung in den Bereichen Naturwissenschaften und Technolgien},url={}}
...
\newglossaryentry{kettle}{name=Pentaho Kettle, description={ist eine Datenintegrations/ETL-Software von Pentaho}}
\newglossaryentry{fme}{name=FME, description={ist eine Software zur Transformation von Geo-Daten (früher als Feature Manipulation Engine bekannt)}}
%------------------------------------------------------------------------------
% Acronyms
%------------------------------------------------------------------------------
\newacronym
